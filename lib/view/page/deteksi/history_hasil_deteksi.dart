...
class HistoryHasilDeteksi extends StatefulWidget {
  final DetectionHistory history;

  HistoryHasilDeteksi({required this.history});

  @override
  _HistoryHasilDeteksiState createState() => _HistoryHasilDeteksiState();
